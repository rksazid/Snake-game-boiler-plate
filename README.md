This game has been taken from the github repository of "janbodnar" and later it has been modified: [repo link](https://github.com/janbodnar/JavaScript-Snake-Game)
